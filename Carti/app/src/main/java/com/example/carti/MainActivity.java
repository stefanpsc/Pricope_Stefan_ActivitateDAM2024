...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Carte> listaCarte = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAdauga = findViewById(R.id.button3);
        btnAdauga.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(getApplicationContext(), ListaCarte.class);
                it.putParcelableArrayListExtra("carte", (ArrayList<? extends Parcelable>)listaCarte);
                startActivity(it);
            }
        });
    }
