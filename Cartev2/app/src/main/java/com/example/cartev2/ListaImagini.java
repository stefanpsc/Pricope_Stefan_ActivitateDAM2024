    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                    ...
                    listaImagini.add(new ImagineDomeniu("Decameronul: ",imagini.get(4), "https://ro.wikipedia.org/wiki/Decameronul"));
                        ...
                        ImagineAdapter adapter = new ImagineAdapter(listaImagini, getApplicationContext(),R.layout.imagini_adapter_layout);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                it.putExtra("link", listaImagini.get(position).getLink());
                startActivity(it);
